...
function WalletComponent({deposit, withdraw, user}) {
    ...
    return (
        <div>
            ...
            {/* balance in dex smart contract or decentralized exchange */}
            <div className ="form-group row">
